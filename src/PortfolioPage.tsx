...
const DEV = {
  ...
  projects: [
    ...
    },
    {
      ...
      role: "Tech lead",
      year: "2024",
      tags: ["Next.js", "tRPC", "Prisma", "Stripe Connect"],
      summary:
        "Multi-vendor marketplace with split payouts, inventory sync, and AI product descriptions. Serves 400+ SKUs across 3 regions.",
      metric: "2.1s avg TTI · 99.97% uptime",
      href: "#projects",
      accent: "water" as const,
    ...
    },
    {
      ...
      role: "Founder",
      year: "2024",
      tags: ["React", "WebGL", "Rust/WASM", "Vision API"],
      summary:
        "Browser-native photo editor with AI background removal, relighting, and batch export. Zero upload — everything runs on-device.",
      metric: "7k monthly actives · 62% D30 retention",
      href: "#projects",
      accent: "fire" as const,
    ...
    },
    {
      ...
      role: "Contractor",
      year: "2023",
      tags: ["Python", "Celery", "ClickHouse", "Grafana"],
      summary:
        "Real-time analytics pipeline for a fintech. Ingests 12M events/day, materialised dashboards, anomaly alerts via Slack.",
      metric: "12M events/day · sub-second query p95",
      href: "#projects",
      accent: "wood" as const,
