...
const DEV = {
  ...
  projects: [
    ...
    },
    {
      ...
      summary:
        "Internal operations platform with role-based access, audit trails, and reporting dashboards. Details on request.",
      metric: "Production internal tool · team-wide rollout",
      href: "#contact",
    ...
    },
    {
      ...
      role: "Founder",
      year: "2024",
      tags: ["Node.js", "Playwright", "Chart.js"],
      summary:
        "On-page SEO scanner — crawls a target site, scores Core Web Vitals and schema coverage, and ships a fix-it checklist.",
      metric: "Actionable SEO audits in under 60 seconds",
      href: "#contact",
      accent: "water" as const,
      visual: "chart" as const,
    },
